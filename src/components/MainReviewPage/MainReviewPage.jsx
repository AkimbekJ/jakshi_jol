      ...
      <div className="container">
         <div className="reviewPage">
              ...
              <div className="review">
                <p>ОТЗЫВЫ</p>      
                <div className="card">
                  <div className="reviewCard"><img src={review1} alt="img" /></div>
                  <div className="reviewCard"><img src={review2} alt="img" /></div>
                  <div className="reviewCard"><img src={review3}alt="img" /></div>
                  <div className="reviewCard"><img src={review4}alt="img" /></div>
                  <div className="reviewCard"><img src={review5} alt="img" /></div>
                </div>
              </div>
            </div> 
          </div>
